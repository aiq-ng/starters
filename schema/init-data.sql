...
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed1', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    (SELECT id FROM payment_terms WHERE name = 'Due in 30 days'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed2', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed3', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed4', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed5', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed6', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed7', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed8', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed9', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm completed10', 
    4000, 500, 160000, 'completed', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW());
