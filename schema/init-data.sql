...
('John', 'Doe', 'john@example.com', 'hashedpassword1', 
    (SELECT id FROM roles WHERE name = 'Human Resources'), 
    'https://i.imgur.com/0GY9tnz.jpeg', 
...
((SELECT id FROM users WHERE email = 'nat@aiq.com'), NULL, (SELECT id FROM items WHERE name = 'Beef'), 'item_stock_adjustment', 
    'Chicken was fresh and tasty.', '2024-01-12'),
((SELECT id FROM users WHERE email = 'sog@aiq.com'), NULL, (SELECT id FROM items WHERE name = 'Beef'), 'item_stock_adjustment', 
