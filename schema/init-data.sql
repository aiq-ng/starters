...
('service', 'Corporate New Year Catering', 
    ...
    6000, 0, 250000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), '2025-01-05'),

('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    (SELECT id FROM payment_terms WHERE name = 'Due in 30 days'), 
    (SELECT id FROM payment_methods WHERE name = 'Bank Transfer'), 
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order1', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    (SELECT id FROM payment_terms WHERE name = 'Due in 30 days'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order2', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order3', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order4', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order5', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order6', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order7', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order8', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order9', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New order Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm new order10', 
    4000, 500, 160000, 'new order', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),


('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    (SELECT id FROM payment_terms WHERE name = 'Due in 30 days'), 
    (SELECT id FROM payment_methods WHERE name = 'Bank Transfer'), 
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress1', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    (SELECT id FROM payment_terms WHERE name = 'Due in 30 days'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress2', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress3', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress4', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress5', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress6', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress7', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress8', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress9', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('In progress Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in progress10', 
    4000, 500, 160000, 'in progress', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),


('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    (SELECT id FROM payment_terms WHERE name = 'Due in 30 days'), 
    (SELECT id FROM payment_methods WHERE name = 'Bank Transfer'), 
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery1', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    (SELECT id FROM payment_terms WHERE name = 'Due in 30 days'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery2', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery3', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery4', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery5', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery6', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery7', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery8', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery9', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW()),
('order', CONCAT('New Year Celebration Pack ', FLOOR(RANDOM() * 1000)), 
    (SELECT id FROM customers WHERE display_name = 'AdeyemiFarms'), 
    ...
    'delivery', 
    (SELECT id FROM users WHERE email = 'jane@example.com'), 
    NOW(), 'Include extra drinks', 'Confirm in delivery10', 
    4000, 500, 160000, 'in delivery', 
    (SELECT id FROM users WHERE email = 'starters@admin.com'), NOW());
...
(SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
...
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order1'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order1'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order2'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order2'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
...
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order3'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new orde4r'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order4'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
...
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order6'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order7'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order7'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order8'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order8'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order9'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order9'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order10'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm new order10'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
...
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress1'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress1'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress2'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress2'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
...
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress5'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress6'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress6'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress7'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress7'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress8'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress8'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress9'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress9'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress10'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm in progress10'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
...
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed1'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00, 
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed1'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed2'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed2'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
...
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed5'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed6'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed6'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed7'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed7'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed8'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed8'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed9'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed9'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed10'), 
 (SELECT id FROM price_lists WHERE item_details = 'Croissant'), 2, 5000.00,
    (SELECT id FROM taxes WHERE name = 'VAT (7.50)')),
((SELECT id FROM sales_orders WHERE customer_note = 'Confirm completed10'), 
 (SELECT id FROM price_lists WHERE item_details = 'Salmon Fillet'), 5, 400.00,
